...
<h1 style="text-align: center">Eliminacion de un result</h1>
<table width='100%'>
    <tr>
...
<?php
  ...
  mysqli_select_db($idDB, $BD_bdatos) or die('No puedo seleccionar BD');
    ...
    $consulta = 'DELETE FROM miw_results.results WHERE id="'.$_GET['id'].'"';
    $resultado = mysqli_query($idDB, $consulta);

   echo "<p style=\"color: blue\">  El result de id: ".$_GET['id']." con usuario: " . $_GET['username'] . " ha sido eliminado de forma correcta</p>";
